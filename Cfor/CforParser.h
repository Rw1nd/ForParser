...
class  CforParser : public antlr4::Parser {
public:
  enum {
    ...
    T__38 = 39, T__39 = 40, T__40 = 41, T__41 = 42, T__42 = 43, For = 44, 
    Identifier = 45, DigitSequence = 46, WS = 47, LINECOMMENT = 48, COMMENT = 49
  };

  enum {
    RuleForStatement = 0, RuleForCondition = 1, RuleForExpression = 2, RuleStatement = 3, 
    RuleCompoundStatement = 4, RuleBlockItemList = 5, RuleBlockItem = 6, 
    RuleExpressionStatement = 7, RuleExpression = 8, RuleAssignmentExpression = 9, 
    RuleConditionalExpression = 10, RuleLogicalOrExpression = 11, RuleLogicalAndExpression = 12, 
    RuleInclusiveOrExpression = 13, RuleExclusiveOrExpression = 14, RuleAndExpression = 15, 
    RuleEqualityExpression = 16, RuleRelationalExpression = 17, RuleShiftExpression = 18, 
    RuleMultiplicativeExpression = 19, RuleAdditiveExpression = 20, RuleUnaryExpression = 21, 
    RuleCastExpression = 22, RulePostfixExpression = 23, RulePrimaryExpression = 24, 
    RuleAssignmentOperator = 25, RuleUnaryOperator = 26
  };

  CforParser(antlr4::TokenStream *input);
  ~CforParser();
